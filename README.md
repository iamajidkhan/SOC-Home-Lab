...
![AWS](https://img.shields.io/badge/AWS-EC2-orange?logo=amazon-aws) ![Splunk](https://img.shields.io/badge/Splunk-10.0.2-brightgreen?logo=splunk) ![Wazuh](https://img.shields.io/badge/Wazuh-4.7.5-blue) ![Suricata](https://img.shields.io/badge/Suricata-8.0.2-red) ![Sysmon](https://img.shields.io/badge/Sysmon-15.15-yellow) ![Active Directory](https://img.shields.io/badge/Active%20Directory-2022-blue?logo=windows)
...
| **[ARCHITECTURE.md](./ARCHITECTURE.md)** | Complete infrastructure documentation with network diagrams, EC2 specifications, VPC Traffic Mirroring setup, Security Groups, and design decisions |
| **[DETECTION-RULES.md](./DETECTION-RULES.md)** | All 6 detection rules with complete SPL queries, MITRE ATT&CK mappings, triggered alert screenshots, and testing methodology |
| **[DASHBOARDS.md](./DASHBOARDS.md)** | Complete specifications for all 5 dashboards (70 panels total) with panel descriptions, search queries, and use cases |
...
💼 **LinkedIn**: [linkedin.com/in/abdul-majid-khan-b14ab7220](https://www.linkedin.com/in/abdul-majid-khan-b14ab7220/)  
