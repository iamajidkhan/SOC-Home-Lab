...
![Brute Force Alert](../screenshots/detections/brute-force/brute-force-triggered-list.png)
*Alert appearing in Splunk Triggered Alerts with HIGH severity*

![Brute Force Query Results](../screenshots/detections/brute-force/brute-force-triggered-details.png)
...
![PowerShell Alert List](../screenshots/detections/powershell/powershell-exec-triggered-list.png)
*PowerShell detection alerts appearing in Triggered Alerts with HIGH severity*

![PowerShell Query](../screenshots/detections/powershell/powershell-exec-triggered-details.png)
*Complete SPL query showing behavioral scoring logic with 7 matching events*

![PowerShell Results with Encoded Commands](../screenshots/detections/powershell/powershell-exec-triggered-details2.png)
...
![Lateral Movement Alert List](../screenshots/detections/lateral-movement/lateral-movement-triggered-list.png)
*Multiple HIGH severity lateral movement alerts for user "radmin" accessing 2 systems*

![Lateral Movement Query Results](../screenshots/detections/lateral-movement/lateral-movement-triggered-details.png)
...
![C2 Beaconing Alert List](../screenshots/detections/c2-beaconing/C2-Beacon-triggered-list.png)
*Multiple HIGH severity C2 beaconing alerts over 2-day period*

![C2 Beaconing Query](../screenshots/detections/c2-beaconing/C2-Beacon-triggered-details1.png)
*SPL query showing beaconing pattern detection across 1,573 events*

![C2 Beaconing Results with Detection Reasoning](../screenshots/detections/c2-beaconing/C2-Beacon-triggered-details2.png)
...
![Privilege Escalation Alert List](../screenshots/detections/privilege-escalation/privilege-escalation-triggered-list.png)
*Multiple HIGH severity privilege escalation alerts for user "radmin"*

![Privilege Escalation Query](../screenshots/detections/privilege-escalation/privilege-escalation-triggered-details1.png)
*SPL query showing privilege assignment tracking with 7 events*

![Privilege Escalation Results](../screenshots/detections/privilege-escalation/privilege-escalation-triggered-details2.png)
